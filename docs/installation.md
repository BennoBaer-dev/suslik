...
docker pull ghcr.io/bennobaer-dev/suslik:0.1.0.360-gpu
docker pull ghcr.io/bennobaer-dev/suslik:0.1.0.360-cuda
docker pull ghcr.io/bennobaer-dev/suslik:0.1.0.360-cpu
docker pull ghcr.io/bennobaer-dev/suslik:0.1.0.360-gpu-legacy
docker pull ghcr.io/bennobaer-dev/suslik:0.1.0.360-rocm
```
...
```yaml
    image: ghcr.io/bennobaer-dev/suslik:0.1.0.360-cpu
```
