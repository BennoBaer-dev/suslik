...
del día vaya completando a las personas conocidas entre medias.</p>""",
    ...
    "gpu.keine_karte_cpu": "El reconocimiento se ejecuta en el procesador. Funciona, pero es unas seis veces más lento por análisis, y una segunda plaza de análisis no aporta nada ahí: el procesador ya usa todos sus núcleos para una.",
    "gpu.balken.speicher": "Memoria",
    "gpu.balken.rechenzeit": "Tiempo de cálculo",
    "gpu.worker": "plaza de análisis",
    ...
    "gpu.noch_moeglich": "Espacio para {n} plaza(s) de análisis más.",
    "gpu.passt_nicht": "Esto no cabe. Reduzca vigilantes o plazas de análisis; de lo contrario el sistema alcanza el límite de memoria y el núcleo decide qué proceso muere.",
    "gpu.regler.titel": "Plazas de análisis",
    "gpu.regler.erklaerung": "Cuántos eventos pueden analizarse a la vez. En {hw} lo más rápido medido fue {n}. Más no resultó más rápido en nuestras pruebas.",
    "gpu.auto": "automático",
    "gpu.vorschlag_ist": "actualmente {n}",
    "gpu.speichern": "Guardar",
    "gpu.neustart_noetig": "Se aplica tras el próximo reinicio del servicio.",
    "gpu.messwerte": "Medido en nuestras máquinas: {worker} MB por plaza de análisis, {erster} MB para el primer vigilante en vivo (lleva los modelos) y unos {weiterer} MB por cada uno adicional. Valores aproximados, no una promesa.",
    "gpu.knopf": "GPU",
    ...
    "gpu.laeuft_wie_eingestellt": 'Activo: el servicio funciona con {n} plaza(s).',
    "gpu.vorschau_zu_wenig": 'No cabe: faltan {fehlt}. Desactive un vigilante en vivo o reduzca una plaza.',
    "gpu.speichern_gesperrt": 'Memoria gráfica insuficiente para ese número de plazas.',
}
