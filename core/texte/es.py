...
T = {
    ...
    "kameras.steckbrief.hinweis":
        "La resoluci\u00f3n del stream se consulta una vez por c\u00e1mara y se guarda. \u00dasalo si has cambiado el stream de una c\u00e1mara o si alguna figura como inaccesible.",
    "kameras.steckbrief.stand": "{n} de {ges} c\u00e1mara(s) consultadas, {fehler} inaccesibles",
    "kameras.steckbrief.laeuft": "comprobando \u2026",
    "kameras.steckbrief.fertig": "se volver\u00e1 a consultar en el pr\u00f3ximo reinicio",
    "readme.einleitung": 'Escribí esto porque estas preguntas surgían una y otra vez.',
    "readme.kontakt": 'Me alegra recibir comentarios:',
    "readme.titel": 'Léeme primero',
        "readme.knopf": 'Léeme primero',
        "readme.schliessen": 'Cerrar',
    ...
    "readme.persoenlich.text": 'Esto es puro hobby. Como arquitecto de TI sénior, me divierte desarrollar algo con IA. Está desarrollado por completo con Claude Code, sobre todo con Fable 5, y con Opus 5 para los agentes.\n\nLo que me gustaría son comentarios, y me alegra que alguien use el sistema. Ese es mi pago.',
    ...
    "antwort.support_token_neu": "nuevo token de soporte creado — el antiguo queda invalido; copialo ahora, se muestra solo esta vez",
    "konfiguration.neustart.titel": "Reiniciar el servicio",
    "konfiguration.neustart.satz": "Reinicia este servicio en el sitio (el contenedor sigue en marcha, todos los datos se conservan). Para cuando el procesamiento parezca atascado; los eventos pendientes se retoman tras el reinicio.",
    "konfiguration.neustart.knopf": "Reiniciar ahora",
    ...
    "konfiguration.support.einmal_hinweis": "El token aparece aqui exactamente una vez tras crearlo — guardalo; despues solo se muestra •••.",
    ...
    "lernanker.detail.nicht_empfohlen":
        ...
        "imagen",
    "lernanker.detail.gewaehlt": "Seleccionadas — {bin} ({n})",
    "lernanker.detail.nicht_gewaehlt":
        "No seleccionadas ({n}) — siguen visibles",
    "lernanker.grund.bildpruefung":
        "no ha pasado la comprobación de la imagen",
    "lernanker.grund.zu_dunkel":
        "demasiado oscura (brillo {luma} — hacen falta {min}+)",
    "lernanker.grund.ueberbelichtet":
        "sobreexpuesta (brillo {luma} — como máximo {max})",
    "lernanker.grund.dublette_phys":
        "detección duplicada (misma cámara y mismo recuadro)",
    "lernanker.grund.fast_gleich": "casi idéntica a {datei}",
    "lernanker.grund.bin_limit":
        "límite por perspectiva alcanzado ({k} conservadas)",
    ...
    "live.test.veraltet_bitte":
        "Esta comprobación tiene {tage} días — vuelve a ejecutar la prueba de "
        "fuente para que los números describan lo que la cámara entrega hoy.",
    ...
    "live.zaehler.funde": "{n} caras encontradas",
    ...
    "live.hoehe.alt_hinweis":
        "Guardado: {alt}p. Ese nivel ya no existe (medido: sin ganancia "
        "frente a {jetzt}p) — este vigilante funciona a {jetzt}p. El valor "
        "guardado y la prueba de fuente siguen siendo válidos; elige uno de "
        "los niveles de arriba para cambiarlo.",
    ...
    "live.detail.kein_bild": "Sin imagen en vivo — este vigilante no está en marcha.",
    "live.detail.kein_bild_test":
        "La última prueba de fuente vio {aufloesung}, procesado como {skala}.",
    "live.detail.kein_bild_ohne_test":
        "Todavía no se ha hecho ninguna prueba de fuente, así que no se sabe "
        "nada de esta señal.",
    "live.abschnitt.erkennung": "Reconocimiento",
    "live.abschnitt.melden": "Avisos",
    "live.abschnitt.frigate": "Eventos de Frigate",
    "live.abschnitt.erweitert": "Ajustes avanzados",
    "live.abschnitt.abtastung": "Muestreo",
    "live.abtastung.schalter": "Mirar de cerca solo cuando algo se mueve",
    "live.abtastung.erklaerung":
        "La detección de caras es la parte cara — una comprobación de "
        "movimiento barata sobre el plano de brillo decide si un fotograma "
        "vale la pena. Mientras se sigue a una persona, el vigilante va "
        "siempre a ritmo completo; solo una escena tranquila se muestrea "
        "menos.",
    "live.abtastung.ruhe_label": "Mirar igualmente cada",
    "live.abtastung.ruhe_einheit": "s",
    "live.abtastung.ruhe_hinweis":
        "Déjalo vacío para usar el tiempo de fin de aparición de esta cámara "
        "— quien se queda quieto no genera movimiento, así que el vigilante "
        "echa un vistazo de vez en cuando (1–600 s).",
    "live.abtastung.schwelle_label": "Sensibilidad (cambio de gris):",
    "live.abtastung.flaeche_label": "área mínima:",
    "live.abtastung.eich_hinweis":
        "Deja ambos vacíos para los valores de fábrica de Frigate. Números "
        "más bajos hacen que el vigilante mire más a menudo; más altos lo "
        "mantienen tranquilo ante un seto con viento. Cada sitio es distinto "
        "— estos valores son de ESTA cámara, no de todo el sistema.",
    "live.abschnitt.guete": "Umbrales de calidad de imagen",
    "live.abschnitt.last": "Medición de carga",
    "live.erkennung.det_zeile":
        "A partir de una puntuación de detección de {wert} un hallazgo cuenta "
        "como cara{marke}.",
    "live.erkennung.det_vorgabe": " (valor por defecto)",
    "live.erkennung.fenster_vor": "Ventana de decision:",
    "live.erkennung.fenster_nach": "s — primero reunir votos, luego anunciar el mejor nombre",
    "live.erkennung.fenster_hinweis": "Desde el primer candidato el vigilante espera este tiempo y luego anuncia al candidato con mas votos, en vez del primero que supere el liston. 0 = anunciar de inmediato (comportamiento hasta 0.1.0.395).",
    "live.erkennung.regel_vor": "Reconocido tras",
    "live.erkennung.regel_mitte": "confirmaciones en",
    "live.erkennung.regel_nach": "segundos",
    "live.erkennung.regel_hinweis":
        "0 segundos significa que cuenta toda la aparición, como hasta ahora. "
        "Una ventana de tiempo ayuda en cámaras donde alguien se queda "
        "parado minutos y dos aciertos casuales muy separados no deberían "
        "contar como un reconocimiento.",
    "live.erkennung.vorrat_zeile":
        "Muestras de calibración: {n} de {deckel} \u2014 una imagen por "
        "aparición, las más antiguas se descartan.",
    "live.erkennung.vorrat_aus":
        "La recogida está desactivada, así que la página de calibración no "
        "tiene nada que mostrar (página del sistema, \"live_kalib_max\").",
    "live.erkennung.latte_e": "impresión de imagen desde {wert}",
    "live.erkennung.latte_t": "reconocibilidad desde {wert}",
    "live.erkennung.latte_aus": "sin definir",
    "live.erkennung.latte_hinweis":
        "Estos dos nunca deciden A QUIÉN se reconoce; eso costaría "
        "confirmaciones. Deciden qué imagen va en el aviso y qué caras se "
        "guardan como muestras de calibración. Se ajustan en la página de "
    ...
    "live.frigate.erklaerung":
        ...
        "evento en Frigate con el nombre en la sub-etiqueta \u2014 una "
        "grabación propia, independiente de la detección de Frigate. La "
        "escritura ocurre en segundo plano: el vigilante nunca espera a "
        "Frigate. En modo de solo lectura no se escribe nada.",
    "live.frigate.abstand_label": "Como mucho un evento por persona cada (s):",
    "live.frigate.abstand_hinweis":
        "Vacío significa: la misma distancia que arriba para los avisos. El "
        "límite cuenta por persona, así que dos personas distintas pueden "
        "escribirse a la vez.",
    "livekalib.titel": "Calibración de la cámara — {name}",
    "livekalib.erklaerung":
        "Estas son caras reales que ha recogido esta cámara \u2014 una "
        "imagen por aparición. Mueve los deslizadores hasta que la selección "
        "te convenza y aplícala. Los valores se guardan solo para ESTA "
        "cámara, porque las escalas de calidad difieren entre cámaras.",
    "livekalib.regler_det": "Puntuación de detección",
    "livekalib.regler_det_prosa":
        "A partir de aquí un hallazgo cuenta como cara. Este sí dirige el "
        "reconocimiento: todo lo que quede por debajo nunca llega a la "
        "comprobación del nombre. Más bajo conserva más material (medido: un "
        "listón alto tiró la mitad del material aprovechable); más alto deja "
        "fuera setos y reflejos.",
    "livekalib.regler_e": "Impresión de imagen",
    "livekalib.regler_e_prosa":
        "Lo limpia y luminosa que se ve la imagen. Esto NO decide a quién se "
        "reconoce \u2014 decide qué imagen va en el aviso y qué caras se "
        "guardan aquí como muestras.",
    "livekalib.regler_t": "Reconocibilidad",
    ...
    "livekalib.js.genutzt": "{n} de {gesamt} muestras pasan",
    "livekalib.js.gespeichert": "guardado",
    "livekalib.js.fehler": "error",
    # --- Kalibrier-Zentralumbau 31.08.: Abschnitte, Katalog-Latte, Material
    "livekalib.zur_uebersicht": "volver a todas las cámaras",
    ...
    "kalib.uebersicht.erklaerung": "Una cámara, un juego de valores. Las escalas de calidad varían de cámara a cámara — medido en una sola instalación, la reconocibilidad mediana de una cámara era más del doble que la de otra. Elige una cámara para fijar sus umbrales.",
    "kalib.uebersicht.leer": "Aún no hay cámaras",
    "kalib.uebersicht.leer_hinweis": "En cuanto Frigate informe de cámaras, aparecerán aquí.",
    "kalib.grenze.titel": "Qué hace la calibración — y qué no",
    "kalib.grenze.satz": "Decide qué imagen se muestra o se envía, qué caras se guardan como muestras y cuáles pueden convertirse en referencia. Nunca decide a quién se reconoce: la comprobación de nombres ve todas las caras, sin filtrar. Está medido, no supuesto — filtrar antes de la votación costó confirmaciones.",
    "kalib.kachel.eigene": "valores propios",
    ...
    "kalib.kachel.leer": "Aún no hay muestras",
    "kalib.kachel.leer_hinweis": "Las muestras llegan de un vigilante en marcha y de los análisis de eventos — o consigue algunas ahora.",
    ...
    "kalib.quelle.aus": "desactivado",
    "kalib.knopf_kalibrieren": "Calibrar",
    ...
    "js.kalib.fehler": "no se pudo buscar material",
    "lernwizard.kachel.benennen": "Asignación inteligente",
    ...
    "lernwizard.k3.altes_verfahren":
        "Estos grupos provienen del método anterior, sin comprobación de calidad. Nombrarlos significaría ordenar imágenes que la ejecución ya no acepta. Inicia una nueva ejecución.",
    ...
    "lernwizard.k3.auto.eins": "{n} se reconoció automáticamente &mdash; compruébalo si quieres.",
    "lernwizard.k3.auto.viele": "{n} se reconocieron automáticamente &mdash; compruébalos si quieres.",
    ...
    "lernwizard.zw.titel_auto": "Grupo {pos} de {gesamt} &mdash; ¿es {name}?",
    "lernwizard.zw.satz":
    ...
    "nav.lernlauf": "Aprendizaje de rostros",
    "nav.anker": "Anclas",
    ...
    "catchup.knopf": 'Recuperar',
    "catchup.knopf.tooltip": 'Hay eventos sin procesar en espera',
    "catchup.dlg.titel": 'Recuperar eventos sin procesar',
    "catchup.dlg.label_stunden": 'Retroceder',
    "catchup.dlg.wort_stunden": 'horas',
    "catchup.dlg.label_limit": 'Como máximo',
    "catchup.dlg.wort_events": 'eventos',
    "catchup.dlg.fuss": 'Solo se recuperan los eventos que nunca se analizaron. Tus ajustes se quedan como están.',
    "catchup.dlg.abbrechen": 'Cancelar',
    "catchup.dlg.los": 'Recuperar',
    "js.catchup.spanne": '{von} a {bis}',
    "js.catchup.geklemmt": 'Solo son posibles {h} h y {n} eventos. ¿Ejecutar con esos valores?',
    "js.catchup.nicht_bereit": 'Primero hay que aprender una persona; después se podrán comprobar estos eventos.',
    "js.catchup.warten": 'Eventos sin procesar en espera: {n}',
    "antwort.catchup_gestartet": 'Recuperando las últimas {stunden} h, como máximo {n} eventos.',
    "antwort.catchup_laeuft": 'Ya hay una recuperación en curso.',
    ...
    "js.unb.teil_frage": "¿Asignar las {n} imágenes marcadas a «{person}»? El resto del grupo sigue en Desconocidos.",
    ...
    "js.live.vorrat_leeren_frage":
        "¿Borrar las muestras de calibración de esta cámara? No se pueden recuperar; el vigilante vuelve a recogerlas desde ahora.",
    ...
    "banner.nachholen.eins":
        ...
        "{gesamt} en cola, {schlange} esperando, {arbeit} en análisis",
    ...
    "unbekannte.mehr_bilder": "+{n} imágenes más en este grupo",
    "unbekannte.knopf_reaktivieren": "reactivar",
    "unbekannte.attr_name": "Nombre (nuevo o existente)",
    "unbekannte.attr_wahl": "Elegir este grupo para fusionar",
    "unbekannte.knopf_zuweisen": "Asignar persona",
    "unbekannte.knopf_teil": "Asignar las {n} marcadas",
    "unbekannte.knopf_ignorieren": "Ignorar",
    "unbekannte.knopf_objekt": "No es una persona",
    "unbekannte.knopf_person": "Sí es una persona",
    "unbekannte.knopf_bulkmerge": "Fusionar los {n} grupos elegidos",
    "unbekannte.knopf_mehr": "Mostrar {n} grupos más",
    "unbekannte.titel": "Desconocidos",
    "unbekannte.anker": "{offen} de {gesamt} grupos siguen esperando",
    "unbekannte.sort_label": "Orden",
    "unbekannte.sort_bilder": "más imágenes",
    "unbekannte.sort_neu": "más recientes",
    "unbekannte.filter_label": "Mostrar",
    "unbekannte.f_offen": "pendientes",
    "unbekannte.f_wieder": "recurrentes",
    "unbekannte.f_heute": "nuevos hoy",
    "unbekannte.f_vorschlag": "fusión sugerida",
    "unbekannte.f_besucher": "silenciados",
    "unbekannte.f_objekt": "no son personas",
    ...
    "unbekannte.satz_objekte":
        ...
        "lista para que nada quede oculto. Marcados a mano o encontrados automáticamente; «Sí es una persona» devuelve uno.",
    ...
    "unbekannte.leer_hinweis":
        ...
        "desconocido.",
    "unbekannte.leer_filter": "Nada en esta vista.",
    "unbekannte.leer_filter_hinweis": "Otros grupos esperan arriba en otro filtro.",
    ...
    "vision.schalter.fehlt_galerien": "{n} de {soll} galerias aprobadas — crea una en 'Crear una galeria'",
    "vision.schalter.fehlt_test": "una prueba de conexion en verde",
    "vision.schalter.fehlt_kandidaten": "imagenes juzgadas como fuente de candidatos — aparecen mientras corre un paso; activa la 'recogida de diagnostico' en Persona si quieres que se conserven",
    ...
    "antwort.unbek_objekt": "marcado como no persona",
    "antwort.unbek_weg": "Este grupo ya no existe (fusionado o limpiado entre tanto); se quita la tarjeta.",
    "antwort.unbek_person": "de nuevo entre los visitantes",
    "antwort.unbek_gemergt": "{n} grupos fusionados en uno",
...
del día vaya completando a las personas conocidas entre medias.</p>""",
    ...
    "systemstat.rueckstau.laeuft": "Trabajo pendiente",
    "systemstat.rueckstau.stand": "En cola · esperando · en análisis",
    ...
    # ------------------------------------------------------ routes/gpu ---
    "gpu.titel": "Tarjeta gráfica",
    "gpu.speicher_gesamt": "de memoria gráfica",
    "gpu.keine_karte": "No se utiliza ninguna tarjeta gráfica.",
    "gpu.keine_karte_cpu": "El reconocimiento se ejecuta en el procesador. Funciona, pero es unas seis veces más lento por análisis, y un segundo hilo de cálculo no aporta nada ahí: el procesador ya usa todos sus núcleos para uno.",
    "gpu.balken.speicher": "Memoria",
    "gpu.balken.rechenzeit": "Tiempo de cálculo",
    "gpu.worker": "hilo de cálculo",
    "gpu.waechter": "vigilante en vivo",
    "gpu.dienst": "servicio",
    "gpu.frei": "libre",
    "gpu.reserve": "reserva",
    "gpu.belegt_andere": "en uso, no atribuible",
    "gpu.worker_prozess": "proceso de análisis (todos los hilos)",
    "gpu.worker_unbekannt": "proceso de análisis (parte no atribuible)",
    "gpu.q.gemessen": "medido",
    "gpu.q.tabelle": "tabla de medición",
    "gpu.q.posten": "valor de referencia",
    "gpu.q.config": "ajuste",
    "gpu.q.formel": "fórmula",
    "gpu.leiste_gemessen": "La barra muestra la tarjeta tal como se mide ahora. Los tramos marcados como valor de referencia provienen de nuestros valores de comparación, porque esta tarjeta no los informa por proceso.",
    "gpu.rechen.erklaerung": "Los vigilantes en vivo decodifican su flujo de forma continua, haya alguien o no. El análisis de eventos trabaja a ráfagas y no aparece aquí.",
    "gpu.rechen.median": "habitual",
    "gpu.rechen.spitze": "hasta, en una cámara concurrida",
    "gpu.rechen.bis": "hasta",
    "gpu.engpass.speicher": "Aquí el límite es la memoria.",
    "gpu.engpass.rechenzeit": "Aquí el límite es el tiempo de cálculo, no la memoria.",
    "gpu.noch_moeglich": "Espacio para {n} hilo(s) de cálculo más.",
    "gpu.passt_nicht": "Esto no cabe. Reduzca vigilantes o hilos de cálculo; de lo contrario el sistema alcanza el límite de memoria y el núcleo decide qué proceso muere.",
    "gpu.regler.titel": "Hilos de cálculo",
    "gpu.regler.erklaerung": "Cuántos eventos puede calcular a la vez el worker de análisis. El trabajo en segundo plano — recolección, recopilación y todo lo que usted pulsa — corre al lado en su propio hilo y ya no ocupa el sitio de un evento.",
    "gpu.regler.legacy": "El modo heredado sin worker de análisis (worker: false) está activado, y allí este ajuste no controla nada: cada evento se calcula en su propio proceso, uno tras otro.",
    "gpu.auto": "automático",
    "gpu.vorschlag_ist": "actualmente {n}",
    "gpu.speichern": "Guardar",
    "gpu.neustart_noetig": "Se aplica tras el próximo reinicio del servicio.",
    "gpu.messwerte": "Medido en nuestras máquinas: {worker} MB por hilo de cálculo, {erster} MB para el primer vigilante en vivo (lleva los modelos) y unos {weiterer} MB por cada uno adicional. Valores aproximados, no una promesa. Los análisis simultáneos fueron lo más rápido en {hw} con {n}; más no resultó más rápido en nuestras pruebas.",
    "gpu.knopf": "GPU",
    "gpu.knopf_tip": "Tarjeta gráfica: qué soporta y cómo repartirla entre análisis y vigilantes en vivo",
    "gpu.gespeichert": "Guardado. Se aplica tras el próximo reinicio.",
    "gpu.nicht_messbar": 'Hay un acelerador en uso, pero su memoria no se puede leer desde dentro del contenedor. El reconocimiento sí se ejecuta en él, solo faltan las barras de memoria de abajo. En sistemas Intel esto es normal: los contadores del controlador no son legibles ahí sin permisos adicionales.',
    "gpu.abschnitt.jetzt": 'Ahora mismo',
    "gpu.kachel.last": 'Carga',
    "gpu.kachel.last_unter": 'toda la tarjeta, última hora',
    "gpu.kachel.last_eigen": 'Nuestra parte',
    "gpu.kachel.last_eigen_unter": 'lo que usa suslik (el total del controlador no es legible en un contenedor)',
    "gpu.kachel.npu": 'NPU',
    "gpu.kachel.npu_unter": 'en Intel el reconocimiento se ejecuta aquí',
    "gpu.kachel.vram": 'Memoria gráfica',
    "gpu.kachel.vram_unter": 'ocupada en la tarjeta',
    "gpu.kachel.ram": 'Nuestra memoria',
    "gpu.kachel.ram_unter": 'una GPU integrada comparte la memoria del sistema, no tiene propia',
    "gpu.kachel.temperatur": 'Temperatura',
    "gpu.kachel.temperatur_unter": 'las tarjetas suelen frenarse solas por encima de 80 °C',
    "gpu.engine.render": 'render',
    "gpu.engine.compute": 'cómputo',
    "gpu.engine.video": 'vídeo',
    "gpu.laeuft.titel": 'En marcha:',
    "gpu.laeuft.zeile": '{plaetze} hilo(s) de cálculo, {belegt} ocupado(s){klassen} · {waechter} vigilante(s) en vivo',
    ...
    "gpu.klasse.live": 'juicio corporal (en vivo)',
    "gpu.zu_live": 'Vigilantes en vivo →',
    "gpu.noch_alt": 'El servicio sigue con {laeuft} hilo(s); están configurados {gesetzt}, efectivos tras el próximo reinicio.',
    "gpu.strang_ez": 'hilo de cálculo',
    "gpu.strang_mz": 'hilos de cálculo',
    "gpu.leiter_plaetze": 'El servicio usa {n} {strang} del presupuesto de la tarjeta; el ajuste es un límite superior.',
    "gpu.leiter_plaetze_wartet": 'El servicio cambia a {n} {strang} del presupuesto de la tarjeta; en uso hasta el próximo arranque: {jetzt} {strang_jetzt}. El ajuste es un límite superior.',
    "gpu.passt_hoechstens": 'Con los vigilantes actuales caben como máximo {n} hilo(s) en la memoria.',
    "gpu.vorschau": 'Dejaría {rest} libres.',
    "gpu.neustart_knopf": 'Reiniciar el servicio ahora',
    "gpu.neustart_frage": '¿Reiniciar el servicio ahora? Los análisis en curso se detienen y se retoman después.',
    "gpu.nicht_erreichbar": 'Servicio no accesible: probablemente se está reiniciando. Recargue en un momento.',
    "gpu.laeuft_wie_eingestellt": 'Activo: el servicio calcula con {n} hilo(s).',
    "gpu.vorschau_zu_wenig": 'No cabe: faltan {fehlt}. Desactive un vigilante en vivo o reduzca un hilo.',
    "gpu.speichern_gesperrt": 'Memoria gráfica insuficiente para ese número de hilos.',
}
