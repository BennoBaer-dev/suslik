...
Personen zwischendurch auffüllen.</p>""",
    ...
    "gpu.keine_karte_cpu": 'Die Erkennung läuft auf dem Prozessor. Das geht, ist je Analyse aber rund sechsmal langsamer, und ein zweiter Analyse-Platz bringt dort nichts: der Prozessor nutzt für einen bereits alle Kerne.',
    "gpu.balken.speicher": 'Speicher',
    "gpu.balken.rechenzeit": 'Rechenzeit',
    "gpu.worker": 'Analyse-Platz',
    ...
    "gpu.noch_moeglich": 'Platz für {n} weitere Analyse-Plätze.',
    "gpu.passt_nicht": 'Das passt nicht. Nimm Wächter oder Analyse-Plätze zurück, sonst läuft das System in die Speichergrenze und der Kernel entscheidet, welcher Prozess stirbt.',
    "gpu.regler.titel": 'Analyse-Plätze',
    "gpu.regler.erklaerung": 'Wie viele Ereignisse gleichzeitig analysiert werden dürfen. Auf {hw} war {n} gemessen am schnellsten. Mehr wurde in unseren Tests nicht schneller.',
    ...
    "gpu.messwerte": 'Auf unseren Maschinen gemessen: {worker} MB je Analyse-Platz, {erster} MB für den ersten Live-Wächter (er trägt die Modelle) und rund {weiterer} MB für jeden weiteren. Näherungswerte, keine Zusage.',
    "gpu.knopf": 'GPU',
    ...
    "gpu.laeuft_wie_eingestellt": 'Aktiv: der Dienst läuft mit {n} Plätzen.',
    "gpu.vorschau_zu_wenig": 'Passt nicht — {fehlt} zu wenig. Schalte einen Live-Wächter ab oder nimm einen Platz zurück.',
    "gpu.speichern_gesperrt": 'Zu wenig Grafikspeicher für diese Platzzahl.',
}
