...
vista del giorno integri le persone conosciute.</p>""",
    ...
    "gpu.keine_karte_cpu": "Il riconoscimento gira sul processore. Funziona, ma è circa sei volte più lento per analisi, e un secondo posto di analisi lì non serve: il processore usa già tutti i suoi core per uno.",
    "gpu.balken.speicher": "Memoria",
    "gpu.balken.rechenzeit": "Tempo di calcolo",
    "gpu.worker": "posto di analisi",
    ...
    "gpu.noch_moeglich": "Spazio per altri {n} posti di analisi.",
    "gpu.passt_nicht": "Così non ci sta. Riduci le sentinelle o i posti di analisi, altrimenti il sistema raggiunge il limite di memoria e il kernel decide quale processo muore.",
    "gpu.regler.titel": "Posti di analisi",
    "gpu.regler.erklaerung": "Quanti eventi possono essere analizzati contemporaneamente. Su {hw} il valore più veloce misurato è {n}. Di più non è risultato più veloce nelle nostre prove.",
    "gpu.auto": "automatico",
    "gpu.vorschlag_ist": "attualmente {n}",
    "gpu.speichern": "Salva",
    "gpu.neustart_noetig": "Ha effetto dal prossimo riavvio del servizio.",
    "gpu.messwerte": "Misurato sulle nostre macchine: {worker} MB per posto di analisi, {erster} MB per la prima sentinella live (porta i modelli) e circa {weiterer} MB per ogni ulteriore. Valori approssimativi, non una promessa.",
    "gpu.knopf": "GPU",
    ...
    "gpu.laeuft_wie_eingestellt": 'Attivo: il servizio gira con {n} posti.',
    "gpu.vorschau_zu_wenig": 'Non ci sta: mancano {fehlt}. Disattiva una sentinella live o togli un posto.',
    "gpu.speichern_gesperrt": 'Memoria grafica insufficiente per questo numero di posti.',
}
